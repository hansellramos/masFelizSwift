...
struct Colores{
    let colores = [
        UIColor(colorLiteralRed: 210/255, green: 90/255, blue: 45/255, alpha: 1),
        ...
        UIColor(colorLiteralRed: 3/255, green: 50/255, blue: 130/255, alpha: 1),
    ]
...
struct Datos{
    ...
    func regresarFraseFeliz() -> String{
